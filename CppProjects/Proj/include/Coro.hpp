...
namespace Bicycle
{
	...
	namespace Coro
	{
		...
		class Coroutine
		{
			...
			private:
				/// Хрнаит потокозависимый указатель на "внутреннюю" структуру (для служебных целей)
				static ThreadLocal Internal;

				/// Флаг текущего состояния (бит 0: если установлен - сопрограмма выполняется;
				/// бит 1: если установлен - сопрограмма завершена )
